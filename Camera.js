...
const Camera = () => {
  ...
  const [image, setImage] = useState("https://firebasestorage.googleapis.com/v0/b/paint-project-361412.appspot.com/o/image%2F1664545195908?alt=media&token=4f4b15fe-862d-499b-919a-950651115e5a");
  ...
  const searchTag = ['spring', 'love', 'tired', 'happy', 'cute', 'normal'];
  ...
  const searchMusic = async () => {
    spotify.searchTracks(searchTag[5], {limit: 1, offset: 8})
    .then(
        function (data) {
  ...
  return (
    <View style={styles.container}>
        ...
        <View style={styles.content}>
            <Image source={{uri: "https://firebasestorage.googleapis.com/v0/b/paint-project-361412.appspot.com/o/image%2F1664545195908?alt=media&token=4f4b15fe-862d-499b-919a-950651115e5a"}} style={{width: 360, height: 492}}/>
        </View>
